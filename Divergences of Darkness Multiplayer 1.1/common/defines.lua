...
country = {
	...
	WRONG_REFORM_RADICAL_IMPACT = 10,
	TECH_YEAR_SPAN = 150,
	...
	RESEARCH_POINTS_ON_CONQUER_MULT = 350, -- multiplier to RP got by conquering as unciv when got enacted military reforms
